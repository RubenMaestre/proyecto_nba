...
from paginas import inicio, datos, eda, aviones, sobre_mi, sobre_proyecto
...
def create_sidebar():
    ...
    with st.sidebar:
        selected = option_menu("Menú", ["Inicio", "Datos", "EDA", "Vuelos en USA", "Sobre el proyecto", "Sobre nosotros"],
            icons=["house", "database", "bar-chart-line", "airplane", "book", "people"],
